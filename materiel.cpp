...
{this->prix=prix; this->reference=reference; this->type=type; this->stock=stock;}int Materiel::getprix(){return prix;}
...
query.prepare("Update TABLE1 set PRIX = :prix , REFERENCE = :reference , TYPE = :type , STOCK = :stock  where PRIX = :prix ");
